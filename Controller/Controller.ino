...
{
    uint8_t xaxis = map(analogRead(0), 0, 1023, 0, 255);
    uint8_t yaxis = map(analogRead(1), 0, 1023, 0, 255);
...
void loop()
{
  _radioData.xaxis = map(analogRead(0), 0, 1023, 0, 255);
  _radioData.yaxis = map(analogRead(1), 0, 1023, 0, 255);
  Serial.println(_radioData.yaxis);
